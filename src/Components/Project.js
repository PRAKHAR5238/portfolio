            ...
            <div className="col-md-4 col-sm-6 col-xs-12" data-aos="flip-right" data-aos-duration="1000">
              <div className="card">
                <div className="cover item-f">
                  <div className="card-back">
                    <a href="https://www.figma.com/proto/FBc0RkUuHVF0oftiEQbZRB/Gate-Keeper-App?type=design&node-id=446-1879&t=J2YoBsIh0gSfmfRC-0&scaling=scale-down&page-id=0%3A1&starting-point-node-id=446%3A1879" target="_blank">Click here for demo</a>
                  </div>
                </div>
              </div>
            </div>
